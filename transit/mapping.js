  ...
  var map;
  var marker;                 // User Location
  var markerT;                // Subway stations
...
function parse() {
  ...
  // If MBTA schedule has successfully been retrieved
  if(xhr.status == 200) {
    ...
    drawStations(); // Draw polylines, set markers, and tables with schedule
  }
}

function drawStations() {

  var linePathCoordinates = new Array();  // Coordinates of stations
 
///////////////////////////////////////////////////////////////////////////////  
////////////// size and color of subway markers ///////////////////////////////
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
  ...
  k = 0;  // Keeps track of coordinates of appropriate stations
  // 5 is subtracted because the last 5 elements refer to a seperate branch
  // of the Red Line which will require their own polyline
...
///////////Polyline and Markers for second branch of Red Line/////////////////////////
